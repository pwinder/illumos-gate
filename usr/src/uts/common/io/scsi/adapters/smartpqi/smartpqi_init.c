...
/* ARGSUSED */
static void
raid_sync_complete(pqi_io_request_t *io, void *ctx)
{
...
/* ---- Only skip physical devices ---- */
static boolean_t
skip_device(char *addr)
{
	return (MASKED_DEVICE(addr) ? B_TRUE : B_FALSE);
}
